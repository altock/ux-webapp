...
| File | Contents |
|------|----------|
| `reference/WORKFLOW.md` | Detailed workflow steps (0-7) |
...
| `reference/WEB_APP_PATTERNS.md` | Auth, API latency, forms, deep links, error handling |
...
| `examples/LOGIN_AUDIT_EXAMPLE.md` | Worked example showing expected output quality |
